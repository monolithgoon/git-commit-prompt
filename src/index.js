...
(async () => {
	try {
		...
		// 3. If not (aka. first time program is run), prompt user to set the program's behaviour via a checklist
		// 4. Persist user specified preferences to a config file
